...
sudo apt update
sudo apt install -y mc zip ncdu wget gnupg unzip nginx certbot fail2ban net-tools apt-transport-https ca-certificates
...
sudo bash /tmp/as/scripts/install_as.sh
