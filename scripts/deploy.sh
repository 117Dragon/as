...
LDAP integration: https://openvpn.net/as-docs/tutorials/tutorial--active-directory-ldap.html#optional--limit-access-to-users-in-ldap-server-and-openvpn-access-server-user-permissions-table
